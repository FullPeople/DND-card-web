...
type TabState = { subclassesOpen?:boolean; focus?:string; edition: string; detailId?: string; filters: FacetSelection; sort: string; descending: boolean; positions: Record<string, number>; collapsed: Record<string, string[]> };
const initial = (tab?:LibraryTab): TabState => ({ edition: 'character', filters: {}, sort: tab==='spell'?'level':'source', descending: false, positions: {}, collapsed: {} });
