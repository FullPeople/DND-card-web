...
type TabState = { subclassesOpen?:boolean; focus?:string; edition: string; enabled: boolean; detailId?: string; filters: FacetSelection; sort: string; descending: boolean; positions: Record<string, number>; collapsed: Record<string, string[]> };
const initial = (tab?:LibraryTab): TabState => ({ edition: 'character', enabled: false, filters: {}, sort: tab==='spell'?'level':'source', descending: false, positions: {}, collapsed: {} });
