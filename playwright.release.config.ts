...
export default defineConfig({
 testDir:'./tests/e2e',testMatch:['refinement183.spec.ts','spells-179.spec.ts','live-update-179.spec.ts','resource-burst182.spec.ts','control-settlement182.spec.ts','inventory-race181.spec.ts','inventory-queue-181.spec.ts','save-race-179.spec.ts'],
